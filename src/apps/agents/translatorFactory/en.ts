...
const translator: Translator = {
  ...
  ifNoneMatchError: () => 'IfNoneMatch was used to detect that the resource was already present',
  ...
  maxEtagsError: () => 'IfMatch and IfNoneMatch cannot be used at the same time',
  missingEtagsError: () => 'IfMatch and IfNoneMatch header are missing',
