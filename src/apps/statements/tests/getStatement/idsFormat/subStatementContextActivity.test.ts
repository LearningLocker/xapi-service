...
describe('get ids statement in sub statement parent contextActivities', () => {
...
describe('get ids statement in sub statement grouping contextActivities', () => {
  activityFormatTest((activity: any): any => {
...
describe('get ids statement in sub statement category contextActivities', () => {
  activityFormatTest((activity: any): any => {
...
describe('get ids statement in sub statement other contextActivities', () => {
  activityFormatTest((activity: any): any => {
