...
const TEST_ID_1_PACK_1 = '1c86d8e9-f325-404f-b3d9-24c451035582';
const TEST_ID_2_PACK_1 = '1c86d8e9-f325-404f-b3d9-24c451035583';
const TEST_ID_3_PACK_1 = '1c86d8e9-f325-404f-b3d9-24c451035584';
const TEST_ID_4_PACK_1 = '1c86d8e9-f325-404f-b3d9-24c451035585';

const TEST_ID_1_PACK_2 = '1c86d8e9-f325-404f-b3d9-24c451035586';
const TEST_ID_2_PACK_2 = '1c86d8e9-f325-404f-b3d9-24c451035587';
...
describe('get statements by sorting', () => {
  ...
  const sortStatements = async (opts: GetStatementsOptions) => {
    await storeStatements(
      [
        createStatement({ id: TEST_ID_1_PACK_1 }),
        createStatement({ id: TEST_ID_2_PACK_1 }),
        createStatement({ id: TEST_ID_3_PACK_1 }),
        createStatement({ id: TEST_ID_4_PACK_1 }),
      ],
    );
    await Promise.resolve(delay(100));
    await storeStatements(
      [
        createStatement({ id: TEST_ID_1_PACK_2 }),
        createStatement({ id: TEST_ID_2_PACK_2 }),
      ],
    );
